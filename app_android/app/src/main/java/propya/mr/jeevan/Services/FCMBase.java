...
public class FCMBase extends FirebaseMessagingService {
        ...
        if(data.containsKey("type")){
            ...
            switch (requestCodes.indexOf(data.get("type"))){
                ...
                case 3://telemedicine
                    ...
                    break;
                case 4://appointmentAck
                    String title = data.get("title");
                    String msg = data.get("msg");
                    showNotif(title,msg,4);
                    break;
    ...
    private void showNotif(String title, String msg,int id) {
        ...
        notificationManager.notify(100+id,builder.build());
