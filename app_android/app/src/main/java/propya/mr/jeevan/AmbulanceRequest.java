        ...
        FirebaseFirestore.getInstance().collection("emergencies").document(emergencyId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(final DocumentSnapshot documentSnapshot) {
                ...
                if(assignedAmbulance != null){
                    AlertDialog.Builder builder = new AlertDialog.Builder(AmbulanceRequest.this).setTitle("Patient already found help").setPositiveButton("Dismiss", new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    LocationServices.getFusedLocationProviderClient(AmbulanceRequest.this).getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
                        @Override
